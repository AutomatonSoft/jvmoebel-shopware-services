...
from domains.ingestion.allowlist import HTTP_EVENT_TYPES
from domains.ingestion.exceptions import EventValidationError
from domains.ingestion.registry import http_event_schema_path
from domains.ingestion.sales_channels import assert_http_channel_allowed
...
def validate_http_event(
    ...
    *,
    ...
    if (
        ...
        or event_type not in HTTP_EVENT_TYPES
    ):
        raise EventValidationError(
